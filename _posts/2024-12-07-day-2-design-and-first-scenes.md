...
**Crystal Character (adds units/health to the player):**
![Player Character](crystal_scene.png)

This is the animated character from the Starter Kit. Simple, readable, and comes with built-in animations.
